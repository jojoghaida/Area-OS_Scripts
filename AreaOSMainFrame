...
<!--  Last Published: Sun Aug 13 2017 07:36:08 GMT+0000 (UTC)  -->
<html data-wf-page="59274eafd86c155b7325c2be" data-wf-site="590f8388928fad05e55a7727">
<head>
  <meta charset="utf-8">
  <title>AREAOS</title>
  <meta content="AREAOS" property="og:title">
  <meta content="width=device-width, initial-scale=1" name="viewport">
  <meta content="Webflow" name="generator">
  <link href="../css/normalize.css" rel="stylesheet" type="text/css">
  <link href="../css/webflow.css" rel="stylesheet" type="text/css">
  <link href="../css/josephghaida.webflow.css" rel="stylesheet" type="text/css">
  <script src="https://ajax.googleapis.com/ajax/libs/webfont/1.4.7/webfont.js" type="text/javascript"></script>
  <script type="text/javascript">WebFont.load({
  google: {
    families: ["Karla:regular,italic,700,700italic:latin-ext,latin"]
  }
});</script>
  ...
  <link href="../images/256.jpg" rel="apple-touch-icon">
  <style>
...
<body class="body-2">
  <div class="areaosheader">
    <div class="topinput" id="topInput">
      <div class="ostitle">// Area.OS //</div>
      <div class="html-embed-3 w-embed">
        <!--  Output  -->
        <span id="Q0Output">In...</span>
        <span id="Q1Output"></span>
        <span id="Q2Output"></span>
        <span id="Q3Output"></span>
        <!--  Output  -->
      </div>
      <div class="lineblue"></div>
    </div>
    <div class="hudutility w-hidden-main w-hidden-medium w-hidden-small">
      <div class="icons w-hidden-main w-hidden-medium w-hidden-small">
        <div class="texty">reset camera</div>
      </div>
    </div>
  </div>
  <div class="areaoscanvas" id="areaoscanvas"></div>
  <div class="footer">
    <div class="icons w-hidden-main w-hidden-medium w-hidden-small">
      <div class="texty">zoom in</div>
    </div>
    <div class="icons w-hidden-main w-hidden-medium w-hidden-small">
      <div class="texty">zoom out</div>
    </div>
    <div class="html-embed w-embed" id="questionDialog">
      <!-- forms  -->
      <div id="Q0">
        <form>
          <label id="labels">Location?:</label>
          <a onclick="formSubmit(0,0)">Tribeca</a> ,
          <a onclick="formSubmit(0,1)">Chelsea</a> ,
          <a onclick="formSubmit(0,2)">Lower&nbspEast&nbspSide</a> ,
          <a onclick="formSubmit(0,3)">Hell's&nbspKitchen</a> ,
          <a onclick="formSubmit(0,4)">Midtown</a> ,
          <a onclick="formSubmit(0,5)">Williamsburg</a> ,
          <a onclick="formSubmit(0,6)">Bed-Stuy</a> ,
          <a onclick="formSubmit(0,7)">Green&nbspPoint</a>.
        </form>
      </div>
      <div id="Q1" style="display: none">
        <form onsubmit="formSubmit(1)">
          <!-- q1 -->
          <label id="labels">Space needed?:</label>
          <input type="number" id="inputSQFT" name="" value="Size in SQFT">
        </form>
      </div>
      <div id="Q2" style="display: none">
        <form>
          <label id="labels">What do you do?:</label>
          <a onclick="formSubmit(2,0)">I&nbspcraft&nbspthings</a> ,
          <a onclick="formSubmit(2,1)">I&nbsppresent&nbspthings</a> ,
          <a onclick="formSubmit(2,2)">I&nbspanalyze&nbspthings</a> ,
          <a onclick="formSubmit(2,3)">I&nbspwrite&nbspthings</a> ,
          <a onclick="formSubmit(2,4)">I&nbspdo&nbspother&nbspthings</a> .
        </form>
      </div>
      <div id="Q3" style="display: none">
        <form>
          <label id="labels">Team Size?:</label>
          <a onclick="formSubmit(3,0)">Alone</a> ,
          <a onclick="formSubmit(3,1)">Small&nbspParty&nbsp[2-4]</a> ,
          <a onclick="formSubmit(3,2)">Larger&nbspParty&nbsp[5-10]</a> ,
          <a onclick="formSubmit(3,3)">Huge&nbspParty&nbsp[11-20]</a> .
        </form>
      </div>
      <!-- /forms  -->
    </div>
  ...
  <!-- <script src="https://gitcdn.link/repo/jojoghaida/Area-OS_Scripts/master/AreaOSMainFrame.js" type="text/javascript">//MainScript</script> -->
  <script>
  //SCENE AND CONTROLS////////////////////////////////////////////////////////////
