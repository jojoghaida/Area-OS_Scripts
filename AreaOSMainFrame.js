...
function dropText(text,pos,font,just,size = 1){
  var geometry = new THREE.TextGeometry( text, {font: font, size: size, height: 0, curveSegments: 30, bevelEnabled: false, bevelThickness: 10, bevelSize: 8, bevelSegments: 5, text-align: center});
  var material = new THREE.MeshBasicMaterial({color: 0x26D8A5});
